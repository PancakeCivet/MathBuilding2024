...
for t in range(0, 101):
    ...
    theta_this = theta_cal_mus(100 - t, theta_0)
    x_this, y_this = x_y_cal(theta_this)
...
x_2r = a * theta_0 * math.cos(theta_0) - 2 * r * k_2 / math.sqrt(k_1 * k_1 + k_2 * k_2)
y_2r = a * theta_0 * math.sin(theta_0) + 2 * r * k_1 / math.sqrt(k_1 * k_1 + k_2 * k_2)
...
for i in range(101, 401):
    if i >= 101 and i < 201:
        t = i - 100
        theta_2 = theta_21 - t / 100 * theta_20
        points[i][0] = (
        ...
        t = i - 200
        theta_3 = theta_31 + theta_30 * t / 100
        points[i][0] = (
